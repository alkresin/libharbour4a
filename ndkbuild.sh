...
$HARBOUR_DIR/bin/linux/gcc/harbour $PRGLIST -n -w -i$HARBOUR_DIR/include -oobj/
...
$HARBOUR_DIR/bin/linux/gcc/harbour $PRGLIST -n -w -i$HARBOUR_DIR/include -i$HARBOUR_DIR/contrib/hbssl -oobj/
